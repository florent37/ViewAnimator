...
public class MainActivity extends Activity {
    ...
    private ImageView imageView4path, imageView4svg;
    private ImageView imageView4follower;
    ...
    public void onBubble(final View view) {
    ...
    private void addHeart() {
        Log.d("liyujiang", "addHeart, size: " + animators.size());
        ...
        ViewAnimator animator = builder.build();
        animator.start();
